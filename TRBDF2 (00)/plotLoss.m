...
close all
clc
trbdf2 = load('FHN_NeuralODE_TrainingLoss_TRBDF2.mat', 'lossHistory');
figure(2)
plot(trbdf2.lossHistory,'-k')
xlabel('Iteration')
ylabel('Loss')
...
%% 5) Evaluation
trbdf2dl = load('trainedFHN_NeuralODE_TRBDF2.mat', 'dlnet');
% Parameters
a = 0.7;
b = 0.8;
epsilon = 0.08;
...
% Predict and plot
[xPred, xTrue, err] = predictWithOde45(trbdf2dl.dlnet, fhn, t, x0, odeOptions);
figure
...
function plotTrueAndPredictedSolutions(xTrue, xPred, err, x0Str)
    ...
    % legend('Ground truth', 'Predicted - TRBDF2', ...
