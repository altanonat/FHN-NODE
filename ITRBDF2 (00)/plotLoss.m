...
close all
clc
itrbdf2 = load('FHN_NeuralODE_TrainingLoss_ITRBDF2.mat', 'lossHistory');
figure(2)
plot(itrbdf2.lossHistory,'-k')
xlabel('Iteration')
ylabel('Loss')
...
%% 5) Evaluation
itrbdf2dl = load('trainedFHN_NeuralODE_ITRBDF2.mat', 'dlnet');
% Parameters
a = 0.7;
b = 0.8;
epsilon = 0.08;
...
% Predict and plot
[xPred, xTrue, err] = predictWithOde45(itrbdf2dl.dlnet, fhn, t, x0, odeOptions);
figure
...
function plotTrueAndPredictedSolutions(xTrue, xPred, err, x0Str)
    ...
    % legend('Ground truth', 'Predicted - I-TRBDF2', ...
